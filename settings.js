...
global.owner = process.env.OWNER_NUMBER  || '233203942147' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=fVMk3TzQ#gzZuF_BfYRqOHBHBV3stgNUf_e06bUPcCmsUD9zODI4' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "233203942147" : process.env.MODERATORS ,    
